package com.lucas.strconsumer.config;
...
public class StringConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> earlContainerFactory(){
    ...
    private RecordInterceptor<String, String> validMessage() {
        return (record, consumer) -> {
            if(record.value().contains("interceptada")){
                log.info("INTERCEPT ::: Possui a palavra chave!");
                return record;
            }
            return record;
        };
